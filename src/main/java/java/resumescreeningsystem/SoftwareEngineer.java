...
// SoftwareEngineer class extends the JobRole class
public class SoftwareEngineer extends JobRole {
    // Constructor to initialize the SoftwareEngineer object
    public SoftwareEngineer(String candidateName, String companyName, int salary, String qualification, String skills) {
    ...
    public boolean getResult() {
        ...
        if (skillset.toLowerCase().contains("java") && skillset.toLowerCase().contains("c++") &&
                qualification.toLowerCase().contains("b-tech")) {
            return true;
        }
        return false;
    }
